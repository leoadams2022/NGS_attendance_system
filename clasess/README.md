...
/*  
        ...
        `id`, `user_name`, `user_id`, `day_date`, `time_in`, `time_out`, `created_at`
        ...
        first you need to set the timeZone 
        ...
        $d=mktime(22, 14, 54, 11, 12, 2014);
        (h24,  i,  sa,  m,  d,  Y,);
        date("Y-m-d h:i:sa", $d);  output 2014-11-12 10:14:54pm
*/
